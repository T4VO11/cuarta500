...
class Encryption:
    ...
    def _get_secret_key():
        ...
        # Solo mostrar advertencia si realmente se está usando la clave por defecto
        # y no hay una clave configurada en el entorno
        if key == Encryption.DEFAULT_SECRET_KEY and not os.getenv('ENCRYPTION_KEY'):
            # Comentado para no mostrar advertencia en cada inicio
